...
//        System.out.println(num3 /= 2); // num3 = num3 / 2;
        ...
        // 증감 연산자 : 피연산자를 1씩 증가 또는 감소시키는 연산자
        int num4 = 10;
//        System.out.println(++num4); // 피연산자의 뒤에 붙은 경우는 후위증감연산자로 동작, 선 대입 후 증가
...
//        System.out.println(x <= y); // true
        ...
        rst1 = (x > 0) && (x > y); // false, && 둘다 참이어야 참
        rst2 = (x > 0) || (x > y); // true, 둘중 하나만 참이어도 참
...
//        int age = sc.nextInt();
//        String adult = (age > 19) ? "성인입니다." : "미성년자입니다"; // 조건식이 참이면 ? 뒤에 코드 실행, 아니면 콜론 뒤의 코드 실행
//        System.out.println(adult);

        // 문자열 결합 연산자
        System.out.println("Java JDK " + 11.04 + 12); // 처음 만나는 데이터 타입이 문자열이이 후 값들이 문자열로 간주 됨
